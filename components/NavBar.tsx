        ...
        <> 
            <div className="relative z-50 bg-neutral-800/50">
                <div className="px-4 mx-auto max-w-7xl sm:px-6">
                    ...
                    <div
                        className="flex items-center justify-between py-6 duration-300 ease-in-out border-b-2 border-none md:space-x-10"
                    >
                        <div className="flex justify-start lg:w-0 lg:flex-1">
                            <Link href="/">
                                <span className="sr-only">OlekAleksander</span>
                                <p className="text-4xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-fuchsia-600">OA</p>
                            </Link>
                        </div>
                ...
                <div
                    id="mobile-nav"
                    className={
                        mobileMenuOpen ? "absolute inset-x-0 top-0 p-2 transition origin-top-right transform md:hidden" : "hidden"
                    }
                >
                    <div>
                        <div
                            className="text-white divide-y-2 rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-neutral-800 divide-neutral-50"
                        >
